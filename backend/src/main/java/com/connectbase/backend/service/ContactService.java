...
public class ContactService {
    ...
    public Page<Contact> searchContacts(String keyword, int page, int size) {
        return contactRepo.searchContacts(keyword, PageRequest.of(page, size));
    }
    ...
    public Contact createContact(Contact contact, MultipartFile imageFile) {
    ...
    public Contact updateContact(long id, Contact updatedContactDetails, MultipartFile imageFile) {
